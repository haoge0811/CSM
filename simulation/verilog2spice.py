...
# This function reads a verilog file
# generates the spice netlist, just the gates 
# writes into spice_file_name
# is independent of the device model for spice 
# independent of capacitances and any other sources 

def verilog2spice(verilog_file_name, spice_file_name):
